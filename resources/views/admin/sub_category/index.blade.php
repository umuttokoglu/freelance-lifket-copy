            ...
            <div class="widget-header">
                <div class="row mb-4">
                    ...
                    <div class="col-xl-6 col-md-6 col-sm-6 col-6 text-end">
                        <a href="{{ route('admin.sub-category.create') }}" class="btn btn-success mt-3">
                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach($subCategories as $subCategory)
                                <tr>
                                    ...
                                    <td>
                                        <p>{{ \Illuminate\Support\Str::limit($subCategory->title_tr, 20) }}</p>
                                    </td>
                                    <td>
                                        <p>{{ \Illuminate\Support\Str::limit($subCategory->parent->title_tr, 20) }}</p>
                                    </td>
                                    <td class="text-center">
                                        ...
                                        <div class="action-btns">
                                            ...
                                            <a href="{{ route('admin.sub-category.destroy', ['sub_category' => $subCategory]) }}"
                                               ...
                                               onclick="event.preventDefault();
                                                    if (confirm('Bu alt kategoriyi silmek, bu alt kategoriye ait tüm ürünleri siler. Devam etmek istediğinize emin misiniz?')) {
                                                        document.getElementById('sub-category-delete-form-{{ $subCategory->id }}').submit();
                                                    }">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                     viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                     stroke-width="2"
